...
public class part1 {
    ...
    private static types getType(String hand){
        ...
        switch(max) {
            ...
            case 4:
                return types.FOUR;
            case 3:
                return (map.size() == 2)? types.FULLHOUSE : types.THREE;
            case 2:
    ...
    private static boolean stronger(String hand1, String hand2) {
        Map<String, Integer> values = Map.of("A", 14, "K", 13, "Q", 12, "J", 11, "T", 10);
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i < tam; i++) {
            ...
            System.out.println("Bet: " + bets.get(order.get(i)));
            System.out.println("Rank: " + (tam - i));
